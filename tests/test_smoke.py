...
class TestDefaultSuite():
  ...
  def test_adminpageTest(self):
    ...
    self.driver.set_window_size(656, 729)
    self.driver.find_element(By.ID, "username").click()
    elements = self.driver.find_elements(By.ID, "username")
    assert len(elements) > 0
    self.driver.find_element(By.ID, "username").click()
    self.driver.find_element(By.ID, "username").send_keys("Victoriaedem")
    self.driver.find_element(By.ID, "password").click()
    self.driver.find_element(By.ID, "password").send_keys("11111111111111111")
  ...
  def test_directorypageTest(self):
    ...
    self.driver.set_window_size(655, 729)
  ...
  def test_joinpageTest(self):
    ...
    assert len(elements) > 0
    self.driver.find_element(By.NAME, "fname").send_keys("Emediong")
    self.driver.find_element(By.NAME, "lname").click()
    self.driver.find_element(By.NAME, "lname").send_keys("Edet")
    self.driver.find_element(By.NAME, "bizname").click()
    self.driver.find_element(By.NAME, "bizname").send_keys("Emerald Devs")
